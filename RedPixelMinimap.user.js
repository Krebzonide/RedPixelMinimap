...
// @version      2.5
// @description  Pixelcanvas Minimap modified to connect to RedPixel Github
...
function updateloop(){
  ...
  // Get JSON of available templates
    GM.xmlHttpRequest({
    method: "GET",
    url: "https://raw.githubusercontent.com/Krebzonide/RedPixelMinimap/main/Templates/data.json",
...
function loadImage(templatearray){
  ...
  image_list[imagepath].src = "https://raw.githubusercontent.com/Krebzonide/RedPixelMinimap/main/Templates/" + imagepath;
